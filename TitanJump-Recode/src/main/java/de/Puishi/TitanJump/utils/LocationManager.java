...
public class LocationManager {
    ...
    private final TitanJump plugin;
    ...
    public LocationManager(TitanJump plugin) {
        this.plugin = plugin;
    ...
    public void load() {
        if (!this.file.exists()) {
            ...
            try {
                ...
                Bukkit.getConsoleSender().sendMessage(Data.getPrefix() + "§cFehler beim laden der locations.yml");
            }
        }
    }
    ...
    public void save() {
        try {
            ...
            Bukkit.getConsoleSender().sendMessage(Data.getPrefix() + "§cFehler beim speichern den locations.yml");
        }
    }
