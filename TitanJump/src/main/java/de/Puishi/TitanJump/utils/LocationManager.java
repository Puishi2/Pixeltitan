...
public class LocationManager {
    ...
    public static File file = new File("plugins/TitanJump/locations.yml");
    ...
    public Location getBlockLocation(String name) {
        ...
        World world = TitanJump.getInstance().getServer().getWorld(this.cfg.getString(name + ".World"));
