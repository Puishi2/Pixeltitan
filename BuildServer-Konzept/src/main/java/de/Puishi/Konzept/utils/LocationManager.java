package de.Puishi.Konzept.utils;

import de.Puishi.Konzept.Konzept;
...
public class LocationManager {
    ...
    public static File file = new File("plugins/Konzept/locations.yml");
    ...
    public Location getBlockLocation(String name) {
        ...
        World world = Konzept.getInstance().getServer().getWorld(this.cfg.getString(name + ".World"));
